...
proc create_root_design { parentCell } {
  ...
  set Mem_Access_Err_Int [ create_bd_port -dir I -type intr Mem_Access_Err_Int ]
  ...
  set_property -dict [ list CONFIG.PCW_CORE0_FIQ_INTR {0} CONFIG.PCW_CORE0_IRQ_INTR {0} CONFIG.PCW_CORE1_FIQ_INTR {0} CONFIG.PCW_CORE1_IRQ_INTR {0} CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {60} CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.preset {ZC702*}  ] $processing_system7_0
  ...
  connect_bd_net -net Mem_Access_Err_Int_1 [get_bd_ports Mem_Access_Err_Int] [get_bd_pins xlconcat_0/In6]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DDR1_bram_ctrl/s_axi_aresetn] [get_bd_pins DDR2_bram_ctrl/s_axi_aresetn] [get_bd_pins PCIe_bram_ctrl/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports PL_Clock] [get_bd_pins DDR1_bram_ctrl/s_axi_aclk] [get_bd_pins DDR2_bram_ctrl/s_axi_aclk] [get_bd_pins PCIe_bram_ctrl/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
